...
public class AddressEntityListener {
    ...
    public void prePersist(AddressEntity address) {
        System.out.println("AddressEntity is about to be persisted: " + address.getAddress());
    ...
    public void postPersist(AddressEntity address) {
        System.out.println("AddressEntity has been persisted: " + address.getAddress());
    ...
    public void preUpdate(AddressEntity address) {
        System.out.println("AddressEntity is about to be updated: " + address.getAddress());
    ...
    public void postUpdate(AddressEntity address) {
        System.out.println("AddressEntity has been updated: " + address.getAddress());
    ...
    public void preRemove(AddressEntity address) {
        System.out.println("AddressEntity is about to be removed: " + address.getAddress());
    ...
    public void postRemove(AddressEntity address) {
        System.out.println("AddressEntity has been removed: " + address.getAddress());
    ...
    public void postLoad(AddressEntity address) {
        System.out.println("AddressEntity has been loaded: " + address.getAddress());
